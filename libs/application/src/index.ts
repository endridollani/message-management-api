...
export { CreateMessageService, type CreateMessageCommand } from './messages/create-message.service';
export {
  ListMessagesService,
...
export {
  ...
  type SearchMessagesCommand,
} from './messages/search-messages.service';
